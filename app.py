...
@st.cache_resource
def load_model():
    with open('C:/Users/ksrag/OneDrive/Desktop/python work/project birthday/twetter analysis/env/sentiment_model.pkl','rb')as model_file:
        model=pickle.load(model_file)
    with open('C:/Users/ksrag/OneDrive/Desktop/python work/project birthday/twetter analysis/env/vectorizer.pkl', 'rb')as vectorizer_file:
